...
exports.getAllTours = async (req, res) => {
  try {
    ...
    /**
     * 1B) Advanced filtering for special query commands
     */
    ...
    /**
     * 4) Pagination ex: page=2&limit=10 -> 1-10 page 1, 11-20 page 2
     */
    const page = req.query.page * 1 || 1; // by default we want one
